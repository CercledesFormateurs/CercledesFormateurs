...
<div class="<?php print $zebra; ?><?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <?php print $picture;?>
  <?php if ($new): ?>
  ...
  <div class="date"> 
    <?php  print 'le&nbsp;'.format_date($comment->created, 'custom', 'd/m/Y').'&nbsp;à&nbsp;'.format_date($comment->created, 'custom', 'H\hs'); ?>
  </div>
