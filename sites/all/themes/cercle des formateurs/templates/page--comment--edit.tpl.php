...
<div class="header--comment--edit">
	<?php if ($page['highlight']): ?><div id="highlighted"><?php print render($page['highlight']); ?></div><?php endif; ?>
	<div class="comment--edit--present">
		<div class="comment--edit--title">
			<h1 class="title--edit--comment">Modifier le commentaire "<?php print_r($page['content']['system_main']['subject']['#value']); ?> [...]"</h1>
		</div>
		<form><input type="button" value="Retour" onClick="history.back()"></form>
	</div>
	<div class="content">
		<?php print $messages; ?>
		<?php hide($page['content']['system_main']['author']); ?>
		<?php hide($page['content']['system_main']['subject']); ?>
		<?php print render($page['content']);?>
	</div>
	<div class="comment--edit--mandatory">
