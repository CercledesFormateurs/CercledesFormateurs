...
<div class="header--node--forum--add">
	<?php if ($page['highlight']): ?><div id="highlighted"><?php print render($page['highlight']); ?></div><?php endif; ?>
	<div class="node--forum--add--present">
		<div class="node--forum--add--title">
			<h1 class="title--forum--add">Créer un nouveau "Sujet de discussion" :</h1>
		</div>
